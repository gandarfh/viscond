...
local Avante = {
	...
	AvanteConflictIncoming = { fg = C.bg, bg = C.light_green },
	AvanteConflictIncomingLabel = { fg = C.blue },

	-- Deletion States
	AvanteToBeDeleted = { fg = C.bg, bg = C.red, style = "strikethrough" },
	AvanteToBeDeletedWOStrikethrough = { fg = C.bg, bg = C.red , style = "bold" },
}
