local highlights = {
  ...
  WinSeparator = { fg = C.dark, bg = C.bg },
  ...
  FoldColumn = { fg = C.bg, bg = C.alt_bg },
  LineNr = { fg = C.context },
  FloatBoder = { fg = C.dark, bg = C.bg },
  Whitespace = { fg = C.bg },
  VertSplit = { fg = C.fg, bg = C.bg },
  CursorLine = { bg = C.bg },
  CursorColumn = { bg = C.dark },
  ColorColumn = { bg = C.dark },
  NormalFloat = { fg = C.context, bg = C.bg },
  Visual = { fg = C.fg, bg = C.dark_blue },
  ...
  Search = { fg = C.fg, bg = C.search_orange },
