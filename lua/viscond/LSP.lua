local LSP = {
  ...
  LspReferenceRead = { bg = Config.transparent_background and "NONE" or C.bg },

  LspReferenceText = { bg = Config.transparent_background and "NONE" or C.bg },
  LspReferenceWrite = { bg = Config.transparent_background and "NONE" or C.bg },
